...
const ContactRow = ({ userImage, number, contactName, lastMasg }) => {
  return (
    <div className="row py-3 px-4 flex gap-4 transition-all ease-in-out cursor-pointer justify-between items-center hover:bg-[#060706]">
